...
linker.cmd: package/cfg/RTOS_config_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/RTOS_config_pem4fcfg.cmd\)\"$""\"D:/manchini/projetos/ppgca_embedded_TM4C_websocket_client/Debug/configPkg/\1\""' package/cfg/RTOS_config_pem4f.xdl > $@
